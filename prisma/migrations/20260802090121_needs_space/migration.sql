...
INSERT INTO "new_User" ("careProfile", "coupleId", "createdAt", "cycleDay", "cycleDayVisible", "email", "firstName", "freeCardsUsed", "id", "mood", "moodUpdatedAt", "partnerProfile", "passwordHash", "pausePartner", "phase", "phaseUpdatedAt", "promptTime", "role", "sosDate", "sosUsed", "subExpiresAt", "subStatus", "updatedAt") SELECT "careProfile", "coupleId", "createdAt", "cycleDay", "cycleDayVisible", "email", "firstName", "freeCardsUsed", "id", "mood", "moodUpdatedAt", "partnerProfile", "passwordHash", "pausePartner", "phase", "phaseUpdatedAt", "promptTime", "role", "sosDate", "sosUsed", "subExpiresAt", "subStatus", "updatedAt" FROM "User";
DROP TABLE "User";
